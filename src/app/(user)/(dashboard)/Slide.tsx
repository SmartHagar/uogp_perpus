      ...
      >
        {dataImg.map((item: any, index) => (
          <SwiperSlide key={index} className="h-full">
            ...
            >
              <div className="hvTopDown after:rounded-xl after:bg-primary-content/60 after:backdrop-blur-sm h-full hover:text-base-content p-6 flex flex-col items-center justify-end gap-4 z-0">
